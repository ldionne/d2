...
public:
    ...
    result_type operator()(Iterator first, Iterator last, Graph& graph) const {
        ...
        //       remove_vertex(). However, since the Graph is a named_graph
        //       using vecS as its out edge list, we can't use remove_vertex
        //       because of iterator invalidation as seen in
